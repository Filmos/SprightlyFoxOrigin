〈toSpaceιmaterialsι{
  "Material": {
    ...
    'betterendforge:thallasium_block': {Stability: 1.7, Potential: 1.6},
    'betterendforge:terminite_block': {Stability: 2.0, Potential: 2.0, "Spread": 0.2},
    ...
    'betterendforge:aeternium_block': {Stability: 28.0, Potential: 2.7},
    'byg:anthracite_block': {Stability: 0.6, Potential: 1.3},
    'minecraft:coal_block': {Stability: 0.5, Potential: 1.1},
    'byg:lignite_block': {Stability: 0.5, Potential: 1.0},
    ...
    'betterendforge:ender_block': {Stability: 0.2, Potential: 1.8, "Spread": 0.3},
    'betterendforge:amber_block': {Stability: 0.3, Potential: 1.4},
...
〈forιiι〈varιjsonSource_Material.keys.length〉ι{
  "baseRegistryName": "〈varᛍblockιjsonSource_Material.keys.〈varιi〉〉",
...
〈overSpaceιmaterialsι〈mergeJsonι〈readSpaceιmaterials〉ι{"Material": {
〈forιmι〈varιjsonSource_Material.keys.length〉ι〈forιiι9ι
  "〈replaceRegexι\w+:ιoverloaded_cb:compressed_ι〈varᛍblockιjsonSource_Material.keys.〈varιm〉〉_〈varιiι+1〉〉": 〈mergeJsonι〈eachJsonι〈varιjsonSource_Material.〈varιblock〉〉ι
*(1.5**〈varιiι+1〉)*10)/10ιMath.round(〉ι{
  Stability: 〈evalιx=〈varιjsonSource_Material.〈varιblock〉.Stability〉; (x>0.4?(Math.round(((x-0.4)*(1.7**〈varιiι+1〉)+0.4)*10)/10):(Math.round((0.4-(0.4-x)*(0.8**〈varιiι+1〉))*10)/10))〉,
  Potential: 〈evalιx=〈varιjsonSource_Material.〈varιblock〉.Potential〉; (x>1?(Math.round(((x-1)*(1.7**〈varιiι+1〉)+1)*10)/10):(Math.round((1-(1-x)*(0.9**〈varιiι+1〉))*10)/10))〉
}〉ι,
〉ι,
〉
}}〉〉
...
〈readFileι../semi-static/monument_materials.js〉〉

〈toFileι../out/kubejs/server_scripts/the_split.jsι
let monument_materials = 〈readSpaceιmaterials〉
〈readFileι../semi-static/the_split.js〉〉